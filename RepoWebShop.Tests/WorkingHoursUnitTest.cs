...
namespace RepoWebShop.Tests
{
    ...
    public class WorkingHoursUnitTest
    {
        ...
        public void CalculatePickupDate()
        {
            ...
            finishingDate = Helpers.WorkingHours.GetOrderReady(orderAccreditted, estimationHs, _processingHours);
            ...
            orderPickup = Helpers.WorkingHours.GetPickUpDate(orderAccreditted, estimationHs, _processingHours, _openHours);
